...
public class UpDownVolumeRatioCalculatorTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UpDownVolumeRatioCalculatorTest.class);
    ...
    public void testCalculate() {
        ...
        double correctAnswer = 0.96d;
        int period = 50; // market sessions
        double calculatedAnswer = new UpDownVolumeRatioCalculator().calculate(quotes, period);
